...
$(function () {
    ...
    $("#post__arrow-prev").on("click", function (event) {
        event.preventDefault();
    
        post.slick('slickPrev');
    });
    
    $("#post__arrow-next").on("click", function (event) {
        event.preventDefault();
    
        post.slick('slickNext');
    });
    ...
    play.on("click", function (event) {
        ...
        var media = $(".video__media").get(0);
    
        var pl__icon = $(".play__icon");
        var pa__icon = $(".pause__icon");
